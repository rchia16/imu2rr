...
DIAG_COLS = [
    ...
    "profile_delta_norm",
    "profile_film_scale",
    "profile_film_placement",
    "profile_film_residual_alpha",
    "profile_qkv_scale",
    "profile_qkv_layers_used",
    "profile_qkv_residual",
    "profile_unsup_episodic_batch",
    "profile_unsup_episodic_batches",
    "profile_vector_norm",
    ...
    "feature_align_source_n",
    "feature_align_target_n",
    "feature_align_feature_dim",
    "feature_align_pre_mae",
    "feature_align_post_mae",
    "feature_align_delta_mae_vs_none",
    "feature_align_pre_corr",
    "feature_align_post_corr",
    "feature_align_delta_corr_vs_none",
    ...
    "feature_align_eval_feature_delta_rms",
    "feature_align_eval_hidden_delta_rms",
    ...
    "feature_adapt_eval_feature_delta_rms",
    "feature_adapt_eval_hidden_delta_rms",
