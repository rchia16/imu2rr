...
try:
    ...
    def _missing_datapipeline(*args, **kwargs):
        raise ModuleNotFoundError(
            "datapipeline is required for raw-data loading utilities, but it is "
            "not installed or not on PYTHONPATH."
        )

    load_and_snip = _missing_datapipeline
    get_windowed_data = _missing_datapipeline
    get_file_list = _missing_datapipeline
