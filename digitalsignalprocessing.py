...
from scipy.signal import convolve, find_peaks, resample_poly
...
def downsample_imu_window(x, orig_fs=120, target_fs=30):
    # x: (T, C) or (B, T, C)
    # 120 -> 30 Hz = divide by 4
    return resample_poly(x, up=1, down=4, axis=-2)
